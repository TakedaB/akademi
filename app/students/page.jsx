            ...
            <table className="w-full">
              <thead>
                <tr className="bg-white-50 border-b">
                  ...
                  <th className="px-6 py-4 text-left text-xs font-semibold text-[#303972]">
                    ID
                  </th>
                  <th className="px-6 py-4 text-left text-sm font-semibold text-[#303972]">
                    Date
                ...
                {currentStudents.length === 0 ? (
                  ...
                  currentStudents.map((student) => (
                    ...
                    >
                      ...
                      <td className="px-6 py-4 text-xs font-medium text-[#A098AE]">
                        {formatToAmericanDate(student.birth_date)}
                      </td>
                      <td className="px-6 py-4 text-xs text-[#303972]">
                        {student.parent_name}
                      </td>
                      <td className="px-6 py-4 text-xs text-[#303972]">
                        {student.city}
                      ...
                      <td className="px-6 py-4">
                        <span
                          className={`px-4 py-1.5 ${getGradeColor(student.grade)} text-white rounded-full text-sm font-medium inline-block`}
                        >
                          {student.grade}
                        </span>
                      </td>
